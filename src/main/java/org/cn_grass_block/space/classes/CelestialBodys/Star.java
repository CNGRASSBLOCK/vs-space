...
public class Star extends CelestialBody {
    ...
    private void RenderModel(Vector3d pos, Vector3d camPos, Quaterniond rotate, Matrix4f matrix, Matrix4f projectionMatrix) {
        ...
        SpaceShader.StarRender.get().safeGetUniform("StarColor").set(RGB[0], RGB[1], RGB[2], 1f);

        vertexBuffer.bind();
        vertexBuffer.drawWithShader(matrix, projectionMatrix, SpaceShader.StarRender.get());
        VertexBuffer.unbind();
    }
