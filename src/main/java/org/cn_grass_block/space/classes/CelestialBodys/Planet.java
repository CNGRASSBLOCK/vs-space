package org.cn_grass_block.space.classes.CelestialBodys;
...
public class Planet extends CelestialBody {
    ...
    private void RenderModel(Vector3d pos, Vector3d camPos, Quaterniond rotate, Matrix4f matrix, Matrix4f projectionMatrix) {
        ...
        SpaceShader.PlanetRender.get().safeGetUniform("PlanetPos").set((float) pos.x(), (float) pos.y(), (float) pos.z());
        ...
        vertexBuffer.bind();
        vertexBuffer.drawWithShader(matrix, projectionMatrix, SpaceShader.PlanetRender.get());
        VertexBuffer.unbind();
    }
}
